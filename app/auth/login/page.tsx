...
export default function Login({
  ...
  return (
    <form
      ...
      action={signIn}
    >
      <h3 className="mb-1 text-md text-[#1A2421]/80">Signin required!</h3>
      ...
      <div className="form-label relative text-black/50 focus-within:text-[#333] block mb-4">
        <svg
          className="label-icon 
                  transition pointer-events-none
                  [ w-6 h-6 ] 
      ...
      <div className="my-2">
        <Link href={'/auth/register'} className="hover:text-blue-700">New here ?</Link>
      </div>
      <button
